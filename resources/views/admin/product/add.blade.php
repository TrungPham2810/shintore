...
@section('content')
    ...
    @include('admin.layouts.content-header', ['name'=>'Product', 'action' => 'Add', 'url' => route('admin.product.index')])
    <!-- Main content -->
        <div class="content">
            @if(session('message'))
                        ...
                        <div class="col-sm-6 p-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('product_name') is-invalid @enderror"
                                       value="{{old('product_name')}}" name="product_name" id="" placeholder="Tên Sản Phẩm" required>
                                @error('product_name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('sku') is-invalid @enderror"
                                       value="{{old('sku')}}" name="sku" id="" placeholder="sku" required>
                                @error('sku')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('import_price') is-invalid @enderror" name="import_price" placeholder="Gía Nhập" value="{{old('import_price')}}" id="product_import_price">
                                @error('import_price')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('price') is-invalid @enderror" name="price" placeholder="Gía Bán" value="{{old('price')}}" id="product_price">
                                @error('price')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('qty') is-invalid @enderror" name="qty" value="{{old('qty')}}" id="product_qty">
                                @error('qty')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
